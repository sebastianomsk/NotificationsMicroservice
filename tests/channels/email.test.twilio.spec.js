...
describe('Channels', () => {
    describe('EmailTwilio', () => {
        ...
        before(function () {
            ...
            // Mock emailTwilio module
            // const emailTwilioMock = {
            //     validate: () => true, // Mock validate function
            //     dispatch: async () => ({ messageResponse: 'Mocked response' }) // Mock dispatch function
            // };
            // // Replace the real module with the mock
            // mockRequire('../../core/helpers/channels/emailTwilio', emailTwilioMock);

            // Initialize server
            channel = require('../../core/helpers/channels/emailTwilio');
        });

        // Stop all mock created
        after(() => {
            mockRequire.stop('../../core/helpers/channels/emailTwilio');
        });
        ...
        describe('#dispatch', () => {
            ...
            it('should return messageResponse when channel dispatch with correct arguments', function (done) {
                ...
                mockRequire('../../core/helpers/channels/emailTwilio', emailTwilioMock);
                // Initialize server
                const channelMock = require('../../core/helpers/channels/emailTwilio');
